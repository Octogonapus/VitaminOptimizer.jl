...
function Base.show(io::IO, entity::Entity)
	println(io,
		"Motor 1=", entity.motors[entity.motor1Index],
		"\nMotor 2=", entity.motors[entity.motor2Index],
		"\nMotor 3=", entity.motors[entity.motor3Index],
...
function GAFitness(entity::Entity)::Float64
	...
	return -1 * (entity.motors[entity.motor1Index].price + entity.motors[entity.motor2Index].price +
		entity.motors[entity.motor3Index].price)
end
...
function GACrossover(entity1::Entity, entity2::Entity)::Entity
	...
	return Entity(
		entity1.motor1Index, entity1.motor2Index, entity1.motor3Index,
		entity2.link1Length, entity2.link2Length, entity2.link3Length,
		entity1.gearRatio1, entity1.gearRatio2, entity1.gearRatio3,
		entity1.limb, entity1.motors)
end

function GAMutate(entity::Entity, mutationProb::Float64)::Entity
	return Entity(
		if (rand() <= mutationProb) rand(1:length(entity.motors)) else entity.motor1Index end,
		if (rand() <= mutationProb) rand(1:length(entity.motors)) else entity.motor2Index end,
		if (rand() <= mutationProb) rand(1:length(entity.motors)) else entity.motor3Index end,
		if (rand() <= mutationProb) rand(entity.limb.minLinks[1].dhParam.r:entity.limb.maxLinks[1].dhParam.r)/1000 else entity.link1Length end,
		if (rand() <= mutationProb) rand(entity.limb.minLinks[2].dhParam.r:entity.limb.maxLinks[2].dhParam.r)/1000 else entity.link2Length end,
		if (rand() <= mutationProb) rand(entity.limb.minLinks[3].dhParam.r:entity.limb.maxLinks[3].dhParam.r)/1000 else entity.link3Length end,
		if (rand() <= mutationProb) randomGearRatio(entity) else entity.gearRatio1 end,
		if (rand() <= mutationProb) randomGearRatio(entity) else entity.gearRatio2 end,
		if (rand() <= mutationProb) randomGearRatio(entity) else entity.gearRatio3 end,
		entity.limb,
		entity.motors
	)
end
...
"""
function randomGearRatio(entity::Entity)::Float64
	if rand() > 0.5
		return rand(Uniform(1, entity.limb.maxGearRatio))
	else
		return rand(Uniform(1/entity.limb.maxGearRatio, 1))
	end
end
...
function makeConstraints()
	...
	return [entity::Entity -> (entity.limb.tipForce * (entity.link1Length + entity.link2Length + entity.link3Length)) -
		...
		entity::Entity -> (entity.limb.tipForce * (entity.link2Length + entity.link3Length) +
				entity.motors[entity.motor3Index].mass * gravity * entity.link2Length) -
				entity.motors[entity.motor2Index].τStall / entity.gearRatio2,

		entity::Entity -> (entity.limb.tipForce * entity.link3Length) -
				entity.motors[entity.motor3Index].τStall / entity.gearRatio3,

		entity::Entity -> (entity.limb.tipVelocity / (entity.link1Length + entity.link2Length + entity.link3Length)) -
				entity.motors[entity.motor1Index].ωFree * entity.gearRatio1,

		entity::Entity -> (entity.limb.tipVelocity / (entity.link2Length + entity.link3Length)) -
				entity.motors[entity.motor2Index].ωFree * entity.gearRatio2,

		entity::Entity -> (entity.limb.tipVelocity / entity.link3Length) -
				entity.motors[entity.motor3Index].ωFree * entity.gearRatio3,
...
function makeNLForceConstaint(entity::Entity)::Float64
	θ3 = π/2 - atan(entity.limb.targetZ/1000, entity.limb.targetX/1000)
	h = sqrt((entity.limb.targetX/1000)^2 + ((entity.limb.targetZ/1000) - entity.link1Length)^2)
	...
	jointTorques = transpose(J) * [0, 0, entity.limb.tipForceClosePos]

	return (jointTorques[2] - entity.motors[entity.motor2Index].τStall / entity.gearRatio2) +
	       (jointTorques[3] - entity.motors[entity.motor3Index].τStall / entity.gearRatio3)
end

function makeRandomEntity(limb::Limb, motors::Array{Motor, 1})::Entity
	return GAMutate(Entity(0, 0, 0, 0, 0, 0, 0, 0, 0, limb, motors), 1.0)
end

function isFeasible(entity::Entity)::Bool
